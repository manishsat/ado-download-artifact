...
class ArtifactDownloader {
    ...
    download(projectId, buildDefinitionId, patToken, orgName, artifactName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const builds = yield buildApi.getBuilds(projectId, [buildDefinitionId], undefined, undefined, undefined, undefined, undefined, undefined, bi.BuildStatus.Completed, undefined, undefined, undefined, 1, undefined, undefined, undefined, undefined, 'master');
            const latestBuild = builds[0];
            // get artifact as zip
            const readableStream = yield buildApi.getArtifactContentZip(projectId, Number(latestBuild.buildNumber), artifactName);
